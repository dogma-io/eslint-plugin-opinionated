...
```bash
git clone https://github.com/<USERNAME>/eslint-plugin-opinionated.git
cd eslint-plugin-opinionated
git remote add upstream https://github.com/dogma-io/eslint-plugin-opinionated.git
```

**SSH**

```bash
git clone git@github.com:<USERNAME>/eslint-plugin-opinionated.git
cd eslint-plugin-opinionated
git remote add upstream git@github.com:dogma-io/eslint-plugin-opinionated.git
```
...
[fork-repo]: https://github.com/dogma-io/eslint-plugin-opinionated#fork-destination-box
